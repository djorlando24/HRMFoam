...
\*---------------------------------------------------------------------------*/
#include "tracerFvPatchScalarField.H"
...
tracerFvPatchScalarField::tracerFvPatchScalarField
(
    const fvPatch& p,
...
tracerFvPatchScalarField::tracerFvPatchScalarField
(
    const tracerFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void tracerFvPatchScalarField::updateCoeffs()
{
   if (updated())
   {
       return;
...
void tracerFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, tracerFvPatchScalarField);
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
