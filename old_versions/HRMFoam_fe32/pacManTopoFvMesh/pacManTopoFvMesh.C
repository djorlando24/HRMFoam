...
namespace Foam
{
    defineTypeNameAndDebug(pacManTopoFvMesh, 0);
...
Foam::pacManTopoFvMesh::calcMotionMask() const
{
...
void Foam::pacManTopoFvMesh::addZonesAndModifiers()
{
    // Add zones and modifiers for motion action

    if (topoChanger_.size() > 0)
    {
        Info<< "void pacManTopoFvMesh::addZonesAndModifiers() : "
...
Foam::pacManTopoFvMesh::pacManTopoFvMesh(const IOobject& io)
:
...
Foam::pacManTopoFvMesh::~pacManTopoFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::pacManTopoFvMesh::update()
{
